...
export const CarritoPage = () => {
  ...
  return (
    ...
    <div className=' d-flex justify-content-end bg-primary'>Total de su compra:${total.toFixed(2)}</div>
        </tbody>
      </table>
      <form className='row col-6'>
        ...
        <label htmlFor="">Ingrese nombre completo que figura en la tarjeta</label>
        <input type="number" className='my-1 form-control'/>
        <label htmlFor="">Ingrese numeros que figuran al frente de su tarjeta</label>
        <input type="number" className='my-1 form-control'/>
        <label htmlFor="">Ingrese codigo de seguridad de 3 digitos de su tarjeta</label>
        <input type="number" className='my-1 form-control'/>
